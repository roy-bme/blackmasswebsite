...
export default function MapLegend() {
  return (
    <div className="inline-flex flex-col gap-2 border border-line-15 bg-ink-900/80 px-3 py-2">
      ...
      <div className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-eyebrow text-fg-mute"><span className="inline-block h-2.5 w-2.5 rounded-full border-2 border-dashed border-[#D4A843] bg-[#D4A843]/10" /> Unattributed (Awaiting)</div>
