import type { Venture } from "@/components/VentureCard";

export const ventures: Venture[] = [
  {
    tag: "FINTECH · PAYMENTS · DIGITAL ASSETS",
    title: "ZimX Finance",
    description:
  ...
  },
  {
    ...
    title: "Project TG",
    description: "Music IP protection platform. Patent filed. Pre-launch.",
    comingSoon: true,
  },
  {
    tag: "ENTERTAINMENT · EVENTS · CULTURE",
    title: "LoveMusicLive",
    description:
