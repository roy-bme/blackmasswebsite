...
| `zimx-2.webp` | ZiGX venture card | ZiGX brand mark. Rendered at a constrained size on the standard subtle dark panel — the logo's own white background shows as a small contained rectangle. |
...
- Logo panels are uniformly a subtle dark tint across every card for visual consistency. New logos should ideally have transparent backgrounds; if a baked background is unavoidable, prefer dark/transparent so it blends with the card panel.
